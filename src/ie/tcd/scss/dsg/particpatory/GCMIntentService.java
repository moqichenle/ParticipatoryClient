...
public class GCMIntentService extends GCMBaseIntentService {
	 ...
	 * information.
	 */
	protected static final String PROJECT_NUMBER = "181720049471";
	...
	public void onRegistered(Context context, String registration) {
		...
		jumpToUserRegister(context);
		/**
		 * lele : when register succeeded, notify user.
		 */
		// sendNotificationIntent(
		// context,
		// "1) Registration with Google Cloud Messaging...SUCCEEDED!\n\n"
	...
	private void jumpToUserRegister(Context context) {

 ...
 * on 2013-08-05 at 19:50:18 UTC 
 * Modify at your own risk.
 */

package ie.tcd.scss.dsg.particpatory.deviceinfoendpoint;
...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://participatorysensing.appspot.com/_ah/api/";
  ...
  public class GetDeviceInfo extends DeviceinfoendpointRequest<ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected GetDeviceInfo(java.lang.String id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo.class);
   ...
   * operation.
   *
   * @param content the {@link ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo}
   * @return the request
   */
  public InsertDeviceInfo insertDeviceInfo(ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    InsertDeviceInfo result = new InsertDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class InsertDeviceInfo extends DeviceinfoendpointRequest<ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected InsertDeviceInfo(ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, content, ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo.class);
    }
  ...
  public class ListDeviceInfo extends DeviceinfoendpointRequest<ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
    ...
    protected ListDeviceInfo() {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
    }
  ...
  public class RemoveDeviceInfo extends DeviceinfoendpointRequest<ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected RemoveDeviceInfo(java.lang.String id) {
      super(Deviceinfoendpoint.this, "DELETE", REST_PATH, null, ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public UpdateDeviceInfo updateDeviceInfo(ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    UpdateDeviceInfo result = new UpdateDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class UpdateDeviceInfo extends DeviceinfoendpointRequest<ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected UpdateDeviceInfo(ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, ie.tcd.scss.dsg.particpatory.deviceinfoendpoint.model.DeviceInfo.class);
    }
